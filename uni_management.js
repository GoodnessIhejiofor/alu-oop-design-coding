...
// Demonstration
const dorm = new DormRoom('Dorm A', '568 ALU Residence street', 500);
const apartment = new Apartment('Apt 101', '776 Azam Collgee Ave', 3);
const student = new Student('Milla John', 'S123456', 'Female');
